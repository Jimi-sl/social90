...
export const GlobalStyles = createGlobalStyle`
  ...
  *::before {
  ...
  header > input, header, .chat-list, .chat-content,.profile-nav.fixed, .modalPost form > textarea,.postCommentBox{border-style: none; border:1px solid ${({ theme }) => theme.toggleBorder};}
