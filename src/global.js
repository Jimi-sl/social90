...
export const GlobalStyles = createGlobalStyle`
  ...
  *::before {
  ...
  .chat-content > div > form,.chat-content > div > form > textarea,.chat-container h1,ul.profile-nav.fixed,.event-search > input{background:${({ theme }) => theme.backColor};}
