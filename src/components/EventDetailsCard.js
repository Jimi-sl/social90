    ...
    render(){
       return(
        <div class="ex-event">
					...
					<div></div>
					<span><Link to={'/Event/Profile'}>{this.props.details.eventProfileOwner}</Link></span>
					<span>{this.props.details.time}</span>
					</div>
					<div class="event-type-info">
					<h3>{this.props.details.eventName}</h3>
					<span>{this.props.details.eventType}</span>
					...
					<span><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="inherit" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> {this.props.details.duration}</span>
					</div>
					<div class="event-footer">
						<span>{this.props.details.ticket}</span>
