...
class EventPoster extends React.Component{
    ...
    render(){
        return (
            <li class="demo-ev">
					<div class="info-event"><span><Link to={'/Event/Details/' + this.props.details.id}><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="inherit" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="8"></line></svg></Link></span><span class="tickets">{this.props.details.ticket_limit - this.props.details.ticket_count} tixs left!</span></div>
